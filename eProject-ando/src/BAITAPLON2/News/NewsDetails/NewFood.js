        ...
        <div class="container">
          ...
          <div class="row new">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 left">
              <div class="tieude">
                <a href="" title="Return to home page" style={{color: 'red'}}> Home page <i class="fas fa-angle-double-right fa-lg"></i> </a><a href="../HomeNews.html" style={{color: 'red'}} title="Return to Event news"> Event news </a> <a href=""><i class="fas fa-angle-double-right fa-lg"></i> Food benefits for health</a>
