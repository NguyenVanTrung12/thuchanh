        ...
        <div class="container">
          ...
          <div class="row new">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 left">
              <div class="tieude">
                <a href="" title="Return to home page" style={{color: 'red'}}> Home page <i class="fas fa-angle-double-right fa-lg"></i> </a><a href="../HomeNews.html" style={{color: 'red'}} title="Return to Event news"> Event news </a> <a href="../NewsDetails/NewsBicycle.html"><i class="fas fa-angle-double-right fa-lg"></i> Event news Bicycle details </a>
              </div>
              ...
              <div class="news_item">
                ...
                <div class="row Tintuc2">
                  ...
                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                    <div class="cart">
                      <a href="./NewsDetails/NewSalos.html"><img src="../img/home-tintuc-6.jpg" alt="" style={{width:'100%'}} /></a>
                      <b> spas for health</b>
