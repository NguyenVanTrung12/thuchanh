    ...
    return (
        <section style={{ marginTop: 50 }}>
            <div class="container" style={{ margin: '40px auto' }}>
                <h2 style={{ textAlign: "center", backgroundColor: '#E5A85B', color: ' aliceblue', padding: 20, borderRadius: 30 }}>PRODUCTS FEATURE</h2>
                <div>
                    <br />
                    <br />
                    <br />
                ...
                <div class="row">
                    ...
                    <div class="row" style={{marginTop:100}}>
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                            <div class="zoom-effect-container">
                                <img src="/img/bannerrrrr" alt="Sample Image" class="image-zoom img-fluid" style={{ width: '100%' }} />
                            </div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                            <div class="zoom-effect-container">
